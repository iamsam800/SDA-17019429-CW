...
public:
    ...
    /** Sets envelope paramaters based off received slider values received through an audio reference in the synth UI class
     ...
     @param *attack gets value of attack slider paramter value in synth UI class
     @param *decay gets value of decay slider paramter value in synth UI class
     @param *sustain gets value of sustain slider paramter value in synth UI class
     @param *release gets value of release slider paramter value in synth UI class
    ...
    /** Sets frequency modulation paramters and calculates the FM sum
     ...
     @param *modFrequency gets FM mod frequency value from slider value in SynthUI
     @param *modIndex gets FM index value from slider value in SynthUI
